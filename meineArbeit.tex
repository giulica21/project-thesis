...
\textit{ fractional moment method} (FMM) by Aizenmann and Molchanov in 1993. We will deal with the second one, which is more elementary 
...
In the first section the Anderson model is introduced as a discrete Schroedinger operator called \textit{Hamiltonian}: 
\[
